/* ============ PRODUCT DATA ============ */
const PRODUCTS = [
  { id:1, name:"Akun Sultan Minecraft Java & Bedrock + 3 Capes Random", cats:["premium"], thumb:"linear-gradient(135deg,#8a5a12,#c98a1f)", label:"AKUN SULTAN", icon:"sultanCrown", price:239000, old:469000, disc:49, rating:4.8, sold:"229 terjual", stock:"Sisa 10" },
  { id:2, name:"Bundle Akun Minecraft Java + Skin Standar", cats:["premium","skins"], thumb:"linear-gradient(135deg,#2fa8ff,#63c7ff)", label:"JAVA + SKIN BUNDLE", icon:"bundlePlus", price:211000, old:470000, disc:55, rating:4.9, sold:"1rb+ terjual", stock:"Sisa 30" },
  { id:3, name:"Account Minecraft Java & Bedrock", cats:["premium"], thumb:"linear-gradient(135deg,#3a7d31,#63c060)", label:"PREMIUM ACCOUNT", icon:"card", price:99000, old:180000, disc:45, rating:4.9, sold:"5rb+ terjual", stock:"Sisa 50", badge:"PALING LARIS" },
  { id:4, name:"Redeem Code Minecoins Bedrock", cats:["premium","minecoins"], thumb:"linear-gradient(135deg,#1a2740,#2c4370)", label:"MINECOINS REDEEM", icon:"coinStack", price:45000, old:90000, disc:50, rating:4.7, sold:"800+ terjual", stock:"Sisa 25" },
  { id:5, name:"Realms Plus 1 Bulan", cats:["realms"], thumb:"linear-gradient(135deg,#7a3fd9,#a375ec)", label:"REALMS PLUS", icon:"tower", price:30000, old:129000, disc:77, rating:4.8, sold:"17rb+ terjual", stock:"Sisa 11" },
  { id:6, name:"Happy Ghast Pilot Coat", cats:["cosmetics"], thumb:"linear-gradient(135deg,#8fb8d9,#c8dcec)", label:"PILOT COAT", icon:"hoodie", price:34999, old:60000, disc:42, rating:4.8, sold:"68 terjual", stock:"Sisa 5" },
  { id:7, name:"Parched Hoodie", cats:["cosmetics"], thumb:"linear-gradient(135deg,#c9a15a,#e8cf9e)", label:"PARCHED HOODIE", icon:"hoodie", price:15000, old:25000, disc:40, rating:4.9, sold:"172 terjual", stock:"Sisa 99" },
  { id:8, name:"Time Well Played Skin", cats:["cosmetics","skins"], thumb:"linear-gradient(135deg,#4c9d6f,#7fd6a3)", label:"TIME WELL PLAYED", icon:"shirt", price:12000, old:20000, disc:40, rating:4.7, sold:"90 terjual", stock:"Sisa 40" },
  { id:9, name:"Golem Hoodie", cats:["cosmetics"], thumb:"linear-gradient(135deg,#8a8f96,#c3c8ce)", label:"GOLEM HOODIE", icon:"hoodie", price:22000, old:30000, disc:27, rating:4.8, sold:"196 terjual", stock:"Sisa 3" },
  { id:10, name:"Focus Retention Helmet", cats:["cosmetics"], thumb:"linear-gradient(135deg,#7a4a2f,#b17847)", label:"FOCUS HELMET", icon:"helmet", price:15000, old:30000, disc:50, rating:4.8, sold:"34 terjual", stock:"Sisa 10" },
  { id:11, name:"Builder Cape", cats:["capes"], thumb:"linear-gradient(135deg,#c92f4f,#e8708b)", label:"BUILDER CAPE", icon:"cape", price:15402, old:28000, disc:45, rating:4.8, sold:"310 terjual", stock:"Sisa 18" },
  { id:12, name:"Skin Pack Eksklusif (10 Skins)", cats:["skins"], thumb:"linear-gradient(135deg,#2c4370,#4f6fa3)", label:"SKIN PACK", icon:"shirt", price:18000, old:32000, disc:44, rating:4.7, sold:"540 terjual", stock:"Sisa 60" },
  { id:13, name:"Cape Legacy Java Edition", cats:["capes"], thumb:"linear-gradient(135deg,#c0392b,#e07a6c)", label:"CAPE LEGACY", icon:"cape", price:75000, old:120000, disc:38, rating:4.6, sold:"45 terjual", stock:"Sisa 7" },
];
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const map = {
    '.banner-art-coin': 'coinStack',
    '.banner-art-shield': 'shield',
    '.banner-art-people': 'people',
    '.banner-art-gem': 'gem',
    '.banner-art-gift': 'gift',
  };
